      ...
      entries: [
        {
          version: "0.4.44",
          date: "2026-09-14",
          title: "DingTalk の引用返信、新しい Issue ステータス設定、より安全なコメント削除、より確実な Lark 連携 QR",
          changes: [],
          features: [
            "DingTalk のグループでの返信に、あなたが送ったメッセージが引用されます。",
            "DingTalk が処理中をリアクションで示し、完了したらもう一度付け直します。",
            "DingTalk のコマンド確認に入力した内容が残り、作られた Issue へ移動できます。",
            "設定の Issue ステータスが、未着手・開始済み・完了・終了に分かれます。",
            "ステータスをドラッグすると、ボードや一覧、ステータスメニューでの並び順が決まります（組み込みも同じ）。",
            "カスタムステータスに好きなアイコンの形を選べます。",
            "DeepSeek Harness Desktop が、手作業の設定なしでランタイムとして見つかります。",
          ],
          improvements: [
            "ステータスをアーカイブするとき、まだ使っている Issue の数が分かり、そこへ移動できます。",
            "DeepSeek Harness のランタイムが起動できないとき、何が足りないかが表示されます。",
            "コマンドラインで、各オートパイロットの前回の実行結果が分かります。",
          ],
          fixes: [
            "コメントを削除しても、その下に付いた返信は残ります。",
            "削除された返信は何も残らず、そこへのリンクは隣のメッセージに着きます。",
            "Windows で作ったスキルのアーカイブが、そのまま使えるスキルとして取り込まれます。",
            "Windows や独自の Hermes ホームのスキルが、スキルタブと取り込みダイアログに出ます。",
            "WeCom がファイルの前に空のメッセージを送らなくなり、送れなかったときはその旨を伝えます。",
            "Lark の連携 QR コードが 1 時間そのまま有効で、最初の確認で切れなくなりました。",
            "古いバージョンのデスクトップアプリでも、サーバー更新後にカスタムステータスが残ります。",
            "同じエージェントに同時に依頼した 2 件のコメントが、エラーにならず 1 つの実行にまとまります。",
            "最終集計のないまま終わった Claude の実行が、トークン数を多く見せなくなりました。",
          ],
        },
        {
          version: "0.4.43",
